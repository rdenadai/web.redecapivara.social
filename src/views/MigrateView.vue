  ...
  <div class="min-h-screen bg-capivara-off-white">
    ...
    <main class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            ...
            <div class="space-y-4 ml-11">
              ...
              >
                ...
                <p class="text-xs text-capivara-stone/60 mt-2">
                  ⚠️ O domínio deve mudar para .redecapivara.social (requerido
                  pelo ATProtocol)
                </p>
              </div>
              ...
              <div>
                ...
                />
                <p class="text-xs text-capivara-stone/60 mt-1">
                  ⚠️ Importante: você receberá um código de confirmação neste
                  email
                </p>
              </div>
          ...
          <div class="pt-6 border-t border-gray-200">
            <label class="flex items-start space-x-3 cursor-pointer">
              ...
              <span class="text-sm text-capivara-stone/70">
                Confirmo que tenho autorização para migrar esta conta e aceito
                os
          ...
          >
            <div class="bg-blue-50 border border-blue-200 rounded-lg p-6">
              ...
              <p class="text-xs text-capivara-stone/60 mt-3">
                ℹ️ Não recebeu? Verifique sua caixa de spam ou aguarde alguns
                minutos.
              </p>
            </div>
          </div>
          ...
          >
            <div class="flex items-start gap-3">
              ...
              <div class="flex-1">
                ...
                <p class="text-sm text-red-700 mt-1">{{ migrationError }}</p>
              </div>
            </div>
            <button
      ...
      <div class="mt-12 text-center">
        <p class="text-capivara-stone/60 mb-4">
          Precisa de ajuda com a migração?
        </p>
        <div class="flex justify-center gap-4">
          <a href="#" class="text-capivara-sky-blue hover:underline text-sm">
            📖 Guia Completo
          </a>
          <a href="#" class="text-capivara-sky-blue hover:underline text-sm">
            💬 Suporte
